 ...
 * @getin: command line input of user
...
/* g_builtin */
int (*get_builtin(char *cmd))(inp_shell *inpsh);
...
/* acc_error1.c */
char *strcat_cd(inp_shell *, char *, char *, char *);
