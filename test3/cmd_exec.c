...
/**
 * _exe_ - determines if is an executable
 *
...
/**
 * chk_err_cmd - verifies if user has permissions to access
 *
 ...
 *
 * @inpsh: data relevant (args and input)
 * Return: 1 on success.
 */
